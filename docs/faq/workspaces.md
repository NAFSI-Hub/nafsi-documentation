...
Your instructions should cover everything a user needs to get started — from setting up the Jupyter server launcher to the specific steps required within the server to achieve the intended outcome of your workspace. 
